...
namespace structures
{
	...
	inline T & HashTable<K, T>::operator[](const K key)
	{
		...
		{
			throw std::logic_error("operator[] in hash_table: Data not found!")
		}
	}
	...
	inline const T HashTable<K, T>::operator[](const K key) const
	{
		...
		{
			throw std::logic_error("const operator[] in hash_table: Data not found!")
		}
	}
	...
	inline T HashTable<K, T>::remove(const K & key)
	{
		...
		{
			throw std::logic_error("remove in hash_table: key not found!")
		}
	}
