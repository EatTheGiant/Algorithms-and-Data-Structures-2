...
namespace structures
{
	...
	{
		PriorityQueueItem<T>* pomItem = new PriorityQueueItem<T>(priority, data);
		PriorityQueueList<T>::list_->add(pomItem); // atribut list_ je v mojom predkovy, oznaceny ako protected
	}
}